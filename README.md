...
See **[DEPLOYMENT.md](./DEPLOYMENT.md)** for a step-by-step cPanel guide. In short: run
`npm run build`, then upload the **contents** of `dist/` (including the `.htaccess` file) to
`public_html`.
